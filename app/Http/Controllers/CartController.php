...
class CartController extends Controller
{
    ...
    public function emptyCart()
    {
            ...
            try {
                // Use the truncate method to empty the "carts" table
                Cart::truncate();
    
                return response()->json(['message' => 'Cart table emptied successfully']);
            } catch (\Exception $e) {
                return response()->json(['error' => 'Error emptying cart table', 'message' => $e->getMessage()], 500);
            }
        }
}
